...
<%@ page import="com.example.medicinedonate.entity.Donate" %>
...
<head>
    ...
    <!-- Favicon-->
    <link type="image/icon" rel="shortcut icon" href="<%=request.getContextPath()%>/img/favicon.ico">
...
<%
    ...
    User user = null;
    ArrayList<Donate> donateList;
    if (session.getAttribute("user") == null) {
        response.sendRedirect("/");
    } else {
        user = (User) session.getAttribute("user");
        donateList = (ArrayList<Donate>) session.getAttribute("donateList");
    }
    ...
    <nav class="navbar navbar-expand-sm" style="background-color: #ffffff">
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <div class="right-menu list-inline no-margin-bottom" style="width: 10%">
                <!--End Message-->
                <a style="color: blue; text-decoration: underline;" href="<%=request.getContextPath()%>/userhome">Home</a>
...
<div class="d-flex align-items-stretch">
    ...
    <div class="page-content" style="background-color: #ffffff;width: 100%">
        ...
        <div class="page-header">
            <div class="container-fluid d-flex align-items-center justify-content-between">
                <div class="left-menu">
                    <h2 class="h5 no-margin-bottom">All User Donated Data </h2>
                </div>
                <!-- <div class="right-menu list-inline no-margin-bottom">
                    <div class="list-inline-item" >
                        ...
                        <button type="button" style="margin-right:1rem;background-color: #ffffff" data-toggle="modal" data-target="#addNotebook" class="btn button-add">View All User Donate Data
                        </button>
    ...
    color: #000;">
                    ...
                    <form action="addMedicine" id="addNotebook" name="addNotebook" method="POST" return="false">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter notebook name" id="medicineName"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter quantity about notebook"
        ...
        <table class="table table-hover table-bordered" style="width: 80%;margin: auto;">
            ...
            <tbody>
                <c:choose>
                    <c:when test="${donateList.size() == 0}">
                        <tr>
                            <td colspan="7" style="text-align: center; color: #000;" id="noData" name="noData">No data found</td>
                        </tr>

                    </c:when>
                    <c:when test="${donateList.size() > 0}">
                        <c:forEach items="${donateList}" var="item">
                            <tr>
                            <td>${item.getId()}</td>
                            <td>${item.getCategory()}</td>
                            <td>${item.getName()}</td>
                            <td>${item.getDonorname()}</td>

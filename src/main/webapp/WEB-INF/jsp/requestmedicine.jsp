...
<div class="d-flex align-items-stretch">
    ...
    <div class="page-content" style="background-color: #ffffff;width: 100%">
        ...
        <!-- Modal-->
                    ...
                    <form action="userRequestMedicine" id="addNotebook" name="addNotebook" method="POST" return="false">
                        <div class="modal-body">


                            <div class="form-group">
                                <label for="medicineName">Medicine Name</label>
                                <input type="text" placeholder="Enter Medicine Name" id="medName"
                                       name="medName" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="Enter Medicine Category"
                                       id="medCategory" name="medCategory" class="form-control">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="medicineSubmit" name="submitRequest" class="btn btn-primary">Submit request</button>
                        </div>
                    </form>
